...
public class SoccerSim{
   ...
   public SoccerSim(double x, double y, double xVel, double yVel, int ballCount){ //hey this is your construcotr
      ...
      // Ball[] soccerBalls = new Ball[ballCount];
   ...
   this.timeSlice = timeSlice;
      ...
      // public boolean aBallMoving(Ball[] ballArray){
      ...
      public Ball[] getBalls(){
         ...
         // public void report(String string, Ball[] ballArray){
         //    System.out.println(string);
         //    for(int i = 0; i < ballArray.length; ++i){
         //       System.out.println(i + ":\t" + ballArray[i].toString());
         //    }
         //    System.out.println();
         // }
   ...
   //   }
      ...
      public static void main( String args[] ) {
         ...
         // System.out.println(ballCount);
         // Ball[] soccerBalls = new Ball[ballCount];
         // Ball[] soccerBalls = new Ball[args.length/4];
         int j = 0;
         ...
         // while (SoccerSim.notCollision(soccerBalls) && SoccerSim.aBallMoving(soccerBalls)){
         //    clock.tick();
         //    for (int i = 0; i < soccerBalls.length; ++i){
         //       soccerBalls[i].move(soccerSim.timeSlice);
         //    }
         //    soccerSim.report();
         // }
         do {
            ...
            // soccerSim.initialReport(soccerBalls);
            // soccerSim.report(string, ballArray);
            // SoccerSim.report("Initial report at" + clock.toString(), ballArray);
            soccerSim.report();
            //soccerSim.collision(soccerBalls);
